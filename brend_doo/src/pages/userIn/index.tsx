        ...
        <div>
            ...
            <main className="flex flex-row w-full gap-5 p-5">
                ...
                <div className="flex overflow-hidden flex-col px-10 pt-10 pb-96 min-w-[230px] rounded-3xl bg-stone-50 max-md:px-5 max-md:pb-24 w-full">
                    ...
                    <div className="flex flex-col mt-10 w-full text-base text-black text-opacity-90 max-md:max-w-full">
                        <div className="flex flex-wrap gap-3 items-center w-full max-md:max-w-full">
                            <div className="flex flex-col grow shrink self-stretch my-auto min-w-[240px] w-[370px] max-md:max-w-full">
                                <input
                                    type="text"
                                    placeholder="İlahə Nəzərova"
                                    className="overflow-hidden px-5 py-5 w-full bg-white border border-solid border-black border-opacity-10 rounded-[100px] max-md:max-w-full"
                                />
                            </div>
                            <div className="flex flex-col grow shrink self-stretch my-auto min-w-[240px] w-[370px] max-md:max-w-full">
                                <input
                        ...
                        <div className="flex flex-wrap gap-3 items-center mt-3 w-full text-black text-opacity-60 max-md:max-w-full">
                            <div className="flex flex-col grow shrink self-stretch my-auto min-w-[240px] w-[370px] max-md:max-w-full">
                                <div className="flex overflow-hidden gap-5 justify-between px-5 py-4 w-full bg-white border border-solid border-black border-opacity-10 rounded-[100px] max-md:max-w-full">
                                    <input
                                        type="password"
